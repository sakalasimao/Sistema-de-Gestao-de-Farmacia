 ...
 *
 */
class Relatorio_catg_pesq extends FPDF
{
  function header(){
    ...
    $this->Cell(150,30, utf8_decode('Relatório de Categorias Cadastradas Por Pesquisa: '.$_SESSION['pesq_report'] ),0,0,'C');
    $this->Ln(20);
  ...
  function footer(){
   ...
   function viewTable($conn){
     ...
     $this->SetFont('Times','', 12);
     $pesqAll = $_SESSION['pesq_report_catg'];
     $cmd = $conn->pdo->query("SELECT * FROM categoria WHERE nomeCategoria LIKE '%$pesqAll%'");
