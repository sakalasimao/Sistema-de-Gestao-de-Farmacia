 ...
 *
 */
class Relatorio_user extends FPDF
{
  function header(){
    ...
    $this->Cell(100,30, utf8_decode('Relatório dos Utilizadores Cadastrados'),0,0,'C');
    $this->Ln(20);
  ...
  function footer(){
   ...
   function viewTable($conn){
     $this->SetFont('Times','', 12);
     $cmd = $conn->pdo->query("SELECT nome, nome_nivel, email FROM usuarios s JOIN nivel n ON  s.fk_acesso_usuario = n.id_nivel  order by id_usuario desc");
