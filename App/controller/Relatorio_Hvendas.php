 ...
 *
 */
class Relatorio_Hvendas extends FPDF
{
  function header(){
    ...
    $this->Cell(100,30, utf8_decode('Relatório de Histório de Vendas'),0,0,'C');
    $this->Ln(20);
  ...
  function footer(){
   ...
   function viewTable($conn){
     ...
     $cmd = $conn->pdo->query("SELECT nome , vendaTotal, vendaDesconto, vendaCliente, pagamento, vendaTroco, vendaData FROM vendas v JOIN usuarios s 
