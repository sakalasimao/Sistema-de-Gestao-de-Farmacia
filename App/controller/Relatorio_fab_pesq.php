 ...
 *
 */
class Relatorio_fab_pesq extends FPDF
{
  function header(){
    ...
    $this->Cell(100,30, utf8_decode('Relatório dos Fabricantes de Pesquisa Por: '.$_SESSION['pesq_report']),0,0,'C');
    $this->Ln(20);
  ...
  function footer(){
   ...
   function viewTable($conn){
    $pesqAll = $_SESSION['pesq_report'];
     $this->SetFont('Times','', 12);
     $cmd = $conn->pdo->query("SELECT id_fabricante, nomeFabricante, pais FROM fabricante  WHERE 
