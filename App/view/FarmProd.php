                  ...
                  <div class="col">
                    <form  method="POST">
                      <div class="input-group mb-3">
                          ...
                          <input type="text" class="input-style" size="50" name="pesq_prod" placeholder="Pesquisar..." title="Pesquisar por Nome, Preço, Categoria, Quantidade">
                  ...
                  <div class="table-responsive">
                    ...
                    if(isset($_POST['pesq_prod'])){
                      ...
                      if(empty($pesq)){
                        ...
                        //var_dump($pesq);
                        $cmd = $conn->pdo->prepare("SELECT nomeProduto, nomeCategoria, precoProduto, 
                        qtdProduto, dataExpProduto from produtos JOIN categoria 
                        ON produtos.fk_categoria_produto = categoria.id_categoria WHERE 
                        nomeProduto LIKE '%$pesq%' OR nomeCategoria LIKE '%$pesq%' OR 
                        precoProduto = :p OR qtdProduto = :q ");
                      $cmd->bindValue(':p', $pesq);
                      $cmd->bindValue(':q', $pesq);
                      $cmd->execute();
                      ...
                      $cmd = $conn->pdo->query("SELECT nomeProduto, nomeCategoria, precoProduto, qtdProduto, dataExpProduto from produtos JOIN categoria 
                      ON produtos.fk_categoria_produto = categoria.id_categoria ORDER BY id_produto DESC");
