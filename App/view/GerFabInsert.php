  ...
  <body>
    ...
    <div class="page">
      ...
      <div class="col mt-5"> <!---CADASTRO--->
        <form  action="../model/AcessarFabricante.php" method="POST">
                ...
                <div class="body-card p-3">
                      ...
                      <div class="row px-2 mb-2 d-flex align-itens-center">
                        ...
                        <div class="col">
                           ...
                           <input type="text" class="input-style form-control-sm  me-1"  style="width: 300px; margin-left: -10px;" name="nome_fab" placeholder="EMS" id=""  required>
                        </div>

                        <div class="col">
                           <label for="" style="margin-left: -10px; font-weight: 500; font-size: 15px; display:block;">Pais</label>
                           <input type="text" class="input-style form-control-sm  me-1"  style="width: 300px; margin-left: -10px;" name="pais_fab" placeholder="Brazil" id=""  required>
                        </div>
                      ...
                      <div class="row px-2 mb-2 d-flex align-itens-center">
                        ...
                        <div class="col">
                          ...
                          <div class="col mt-2">
                              <button type="submit" name="'btn_cadastrar_fab" class="btn btn-success btn-sm me-2">Cadastrar</button>
