  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <div class="col"> <!---CADASTRO--->
        <form  action="../model/AcessarFuncionario.php" method="POST">
...
<div class="row px-2 mb-2 d-flex align-itens-center">
  ...
  <div class="col">
     ...
     <input type="text" class="input-style form-control-sm  me-1"  style="width: 300px; margin-left: -10px;" name="nome_func" placeholder="Maria de Souza" id=""  >
  </div>

  <div class="col">
     <label for="" style="margin-left: -10px; font-weight: 500; font-size: 15px; display:block;">Telefone</label>
     <input type="number" min= "1"class="input-style form-control-sm  me-1"  style="width: 300px; margin-left: -10px;" name="tel_func" placeholder="959873857" id=""   >
  </div>
  ...
  <div class="row px-2 mb-2">
    ...
    <div class="col">
      ...
      <input type="email" class="input-style form-control-sm  me-1"  style="width: 300px; margin-left: -10px;" name="email_func" placeholder="mariesouza@gmail.com" id=""   >
    </div>

    <div class="col mt-1">
      <label for="" style="margin-left: -10px; font-weight: 500; font-size: 15px; display:block;">Endereço</label>
      <input type="text" class="input-style form-control-sm  me-1"  style="width: 300px; margin-left: -10px;" name="end_func" placeholder="Morada ,Bairro, Rua," id="">
    </div>
    ...
    <div class="col">
      ...
      <input type="text" class="input-style form-control-sm  me-1"  style="width: 300px; margin-left: -10px;" name="cargo_func" placeholder="Farmaceutico" id="" >
    </div>

    <div class="col mt-4">
        <button type="submit" name="btn_cadastrar" class="btn btn-success btn-sm me-2">Cadastrar</button>
