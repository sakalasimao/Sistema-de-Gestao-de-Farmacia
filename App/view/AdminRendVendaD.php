        ...
        <div class="container mt-3">
          ...
          <div class="row mb-3 ms-1">
            ...
            <div class="btn-group " role="group" aria-label="Basic example">
              ...
              <a class="btn btn-success active">Venda Diarias</a>
              <a href="AdminRendYear.php" class= "btn btn-success ">Vendas Anuais</a>
              </div>
          </div>
                ...
                <div class="body-card p-2">
                  <div class="table-responsive">
                    ...
                    <table class="table table-borderless" id="table_funcionario">
                      ...
                      $cmd = $conn->pdo->query("SELECT venda_user, venda_total, venda_desconto, nome_cliente, pagamento,pagamento_cliente, venda_troco, venda_data from vendas inner join tipopag on vendas.tipo_pagamento = tipopag.id_pag where venda_data = curdate() ORDER BY id_venda DESC;");
