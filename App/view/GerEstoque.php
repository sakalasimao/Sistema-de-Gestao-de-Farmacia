    ...
    <div class="page">
      ...
      <div class="content">
               ...
               <?php //var_dump($_POST); ?> 
                    ...
                    ---->
                        <div class=" btn-group btn-group-sm" role="group" aria-label="Basic example">
                            ...
                            <a class="btn btn-success" title="Relatório Geral" href="../model/AcessarEstoque.php?report_stock_01"><i class="fa-solid fa-file-lines"></i> Relatório Geral</a>
                          </div>
        ...
        <div class="row mt-2 ms-4" style="float: left;">
          <div class="col">
            <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
            <a class="btn btn-success active">Produtos</a>
        ...
        <span style="color: red;">Produtos para Comprar</span> 
        </div>
                   ...
                   if(isset($_POST['pes'])){
                    ...
                    ON e.fk_produto_estoque = p.id_produto where nomeProduto LIKE '%$pesqAll%' OR barcode = :barcode  OR 
                     ...
                     while ($res = $cmd->fetch(PDO::FETCH_ASSOC)) {
                       ...
                       ?>
                       <tbody>
                         <tr <?php if($res['saida'] < $res['qtdCompraProduto']) {echo "style = 'color:red'";}?> >
                         <td><?php
                              if($res['barcode'] == ""){
                                $barcode = "SEM CÓDIGO";
                              }else{
