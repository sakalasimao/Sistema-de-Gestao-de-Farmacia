                    ...
                    <div class="col ">
                            <div class="row" >
                                <div class="col">
                                    ...
                                    <span><?php echo $_SESSION['nome_farmaceutico']; ?></span>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col">
                                    <label for="" class="me-2"> <strong>Farmacêutico </strong></label>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span><?php  echo $_SESSION['email_farm']; ?></span>
                                </div>
                            </div>
                    </div>
                </div>
                    ...
                    <form method="POST">
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col">
                                    ...
                                    <span ><input type="email"  style="box-shadow: 0 0 0 0; outline: 0; border: 2px solid #eee; padding: 5px; border-radius: 5px;" name="email" placeholder="<?php  echo $_SESSION['email_farm']; ?>" required></span>
                            ...
                            <?php
                                if(isset($_POST['email'])){
                                    $id_user_admin = $_SESSION['id_usuario_farm'];
