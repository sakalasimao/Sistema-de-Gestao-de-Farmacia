...
<html lang="pt-pt">
  ...
  <body>
    ...
    <div class="sidebar">
     ...
     <form  action="../model/AcessarUsuario.php" method="POST">
...
<div class="row px-2 mb-2 d-flex align-itens-center">
  ...
  <div class="col">
     <label for="" style="margin-left: -10px; font-weight: 500; font-size: 15px; display:block;">Nome do Completo <span style="color:red;">*</span></label>
     <input type="text"  class="input-style form-control-sm  me-1"  style="width: 300px; margin-left: -10px;" name="nome_user"  placeholder = "Amélia Figueiro" required>
  </div>

  <div class="col">
     <label for="" style="margin-left: -10px; font-weight: 500; font-size: 15px; display:block;">Senha <span style="color:red;">*</span></label>
     <input type="number" min = "1" class="input-style form-control-sm  me-1"  style="width: 300px; margin-left: -10px;" name="senha_user" placeholder="1234"  required>
  </div>
  ...
  <div class="row px-2 mb-2">
    ...
    <div class="col">
      <label for="" style="margin-left: -10px; font-weight: 500; font-size: 15px; display:block;">E-mail <span style="color:red;">*</span></label>
      <input type="email" class="input-style form-control-sm  me-1"  style="width: 300px; margin-left: -10px;" name="email_user" placeholder="ameliafigueiro@gmail.com"  >
    </div>

    <div class="col">
    <label for="" style="margin-left: -10px; font-weight: 500; font-size: 15px; display:block;"> Nível de Acesso <span style="color:red;">*</span></label>
    ...
    <?php
        ...
        if ($cmd->rowCount() > 0) {
          ...
          echo "<option value='{$res['id_nivel']}'>{$res['nome_nivel']}</option>";
    ...
    <div class="row px-2 mb-2">
      ...
      <div class="col mt-4">
            <button type="submit" name="btn_cadastrar_user" class="btn btn-success btn-sm me-2">Cadastrar</button>
