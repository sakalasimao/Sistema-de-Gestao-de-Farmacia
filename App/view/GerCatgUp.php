        ...
        <div class="container mt-3">
          ...
          <?php
                                  ...
                                  if (isset($_POST['btn_up_catg'])) {
                                   ...
                                   $catg->atualizarDados($id_upd, $nome);
                                   $_SESSION['catg_up'] = "";
                ...
                <div class="body-card p-3">
                      ...
                      <div class="row px-2 mb-2 d-flex align-itens-center">
                        ...
                        <div class="col">
                           ...
                           <input type="text" class="input-style form-control-sm  me-1"  style="width: 300px; margin-left: -10px;" name="nome_catg" placeholder="Cápsulas" value="<?php if (isset($res)) {echo $res['nomeCategoria'];} ?>" required>
                        </div>

                          <div class="col mt-4">
                              <button type="submit" name="btn_up_catg" class="btn btn-success btn-sm me-2">Atualizar</button>
