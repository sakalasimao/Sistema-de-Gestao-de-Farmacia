               ...
               <?php //var_dump($_POST); ?> 
                    ...
                    ---->
                        <div class=" btn-group btn-group-sm" role="group" aria-label="Basic example">
                            ...
                            <a class="btn btn-success" title="Relatório Geral" href="../model/AcessarEstoque.php?report_stock_02"><i class="fa-solid fa-file-lines"></i> Relatório Geral</a>
                          </div>
        ...
        <div class="row mt-2 ms-4" style="float: left;">
          <div class="col">
            ...
            <a class="btn btn-success " href="GerEstoque.php">Produtos</a>
                    <a class="btn btn-success active">Expirados daqui a um mês</a>
                    <a href="GerEstoque_JaExp.php" class="btn btn-success">Já expirados</a>
              </div>
          </div>
        </div>
                 ...
                 <thead>
                   ...
                   if(isset($_POST['pes'])){
                    ...
                    ON e.fk_produto_estoque = p.id_produto where nomeProduto LIKE '%$pesqAll%' OR barcode = :barcode  OR 
                     ...
                     $cmd = $conn->pdo->query("SELECT barcode, nomeProduto, estrada,  qtdProduto as saida, qtdCompraProduto,
                     criandoProduto,  date_sub(curdate(), interval 1 month) as expiracao from estoque e JOIN produtos p 
                    ON e.fk_produto_estoque = p.id_produto where year(dataExpProduto) = year(now())" );
